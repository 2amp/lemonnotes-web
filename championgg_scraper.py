...
def parse_item(link, driver):
    ...
    item['champion_name'] = driver.find_element_by_css_selector(champion_css_selector).text
    ...
    if item['role'] == 'Support':
        item['champions_that_counter'] = [{'champion_name': a[0], 'win_rate': a[1]} for a in zip(champions_that_counter[:5], champions_that_counter_win_rates[:5])]
        item['support_adcs_that_counter'] = [{'champion_name': a[0], 'win_rate': a[1]} for a in zip(champions_that_counter[5:10], champions_that_counter_win_rates[5:10])]
        item['support_adcs_that_synergize_poorly'] = [{'champion_name': a[0], 'win_rate': a[1]} for a in zip(champions_that_counter[10:], champions_that_counter_win_rates[10:])]
        item['champions_that_this_counters'] = [{'champion_name': a[0], 'win_rate': a[1]} for a in zip(champions_that_this_counters[:5], champions_that_this_counters_win_rates[:5])]
        item['support_adcs_that_this_counters'] = [{'champion_name': a[0], 'win_rate': a[1]} for a in zip(champions_that_this_counters[5:10], champions_that_this_counters_win_rates[5:10])]
        item['support_adcs_that_synergize_well'] = [{'champion_name': a[0], 'win_rate': a[1]} for a in zip(champions_that_this_counters[10:], champions_that_this_counters_win_rates[10:])]
    elif item['role'] == 'ADC':
        item['champions_that_counter'] = [{'champion_name': a[0], 'win_rate': a[1]} for a in zip(champions_that_counter[:5], champions_that_counter_win_rates[:5])]
        item['adc_supports_that_counter'] = [{'champion_name': a[0], 'win_rate': a[1]} for a in zip(champions_that_counter[5:10], champions_that_counter_win_rates[5:10])]
        item['adc_supports_that_synergize_poorly'] = [{'champion_name': a[0], 'win_rate': a[1]} for a in zip(champions_that_counter[10:], champions_that_counter_win_rates[10:])]
        item['champions_that_this_counters'] = [{'champion_name': a[0], 'win_rate': a[1]} for a in zip(champions_that_this_counters[:5], champions_that_this_counters_win_rates[:5])]
        item['adc_supports_that_this_counters'] = [{'champion_name': a[0], 'win_rate': a[1]} for a in zip(champions_that_this_counters[5:10], champions_that_this_counters_win_rates[5:10])]
        item['adc_supports_that_synergize_well'] = [{'champion_name': a[0], 'win_rate': a[1]} for a in zip(champions_that_this_counters[10:], champions_that_this_counters_win_rates[10:])]
    else:
        item['champions_that_counter'] = [{'champion_name': a[0], 'win_rate': a[1]} for a in zip(champions_that_counter, champions_that_counter_win_rates)]
        item['champions_that_this_counters'] = [{'champion_name': a[0], 'win_rate': a[1]} for a in zip(champions_that_this_counters, champions_that_this_counters_win_rates)]
    return item
